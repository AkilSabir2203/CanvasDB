            ...
            <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto ">
               ...
               >
                  <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg realtive flex flex-col w-full bg-white outline-none focus:outline-none ">
                     {/* HEADER */}
                     <div className="flex items-center p-6 rounded-t justify-center relative border-b border-neutral-200 dark:bg-neutral-800 dark:text-white">
                        <button
                           onClick={handleClose}
                           className="p-1 border-0 hover:opacity-70 transition absolute right-9"
                        >
                           <IoMdClose size={18} className="dark:text-white text-neutral-800 "/>
                        </button>
                        <div className="text-lg font font-semibold">{title}</div>
                     </div>
                     {/* BODY */}
                     <div className="relative p-6 flex-auto text-neutral-700 dark:text-white dark:bg-neutral-800">{body}</div>
                     {/* FOOTER */}
                     <div className="flex flex-col gap-2 p-6 dark:bg-neutral-800">
